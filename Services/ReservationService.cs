...
namespace ReservationSystem2022.Services
{
    public class ReservationService : IReservationService
    {
            ...
            public async Task<ReservationDTO> GetReservationAsync(long id) // haetaan varaus ID mukaan
            {
            ...
            public async Task<IEnumerable<ReservationDTO>> GetReservationsAsync() // haetaan varaukset
            {
